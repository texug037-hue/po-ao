...
function renderItens(){
  ...
  if(db.itensFreteOn) totalFinal += db.freteValue;
...
function renderItensList(){
  ...
  if(db.itensFreteOn){
    // frete sempre por último na lista, com custo 0 (é só um acréscimo, não tem custo associado)
    const freteAmount = isCusto ? 0 : db.freteValue;
    html += `
      <div class="product-item" style="border-bottom:1px solid var(--line); padding:11px 4px">
        <div class="left">
